import numpy as np
import os
from CODE.config import opt
from saliency_metric import cal_mae,cal_fm,cal_sm,cal_em,cal_wfm
from CODE.util.PL_dataset import test_dataset_VDT

dataset_path_pre = '/home/data/tbb/TLD_TBB/RESULT_1_THNet/THNet_Distillation/'  ##pre_salmap_path
test_datasets = ['image/']     ##test_datasets_name
#
